...
define("USRLAN_155", "Um total de {TOTAL} emails foram encontrados. {DELCOUNT} foram apagados nas opções.<br />{DELUSER} usuários marcados como 'devolvedores' (bounced) (sem {FOUND} emails encontrados)");
define("USRLAN_156", "Endereço de email já está em uso");
define("USRLAN_160", "Total de --COUNT-- usuários do tipo --TYPE-- deletados");
define("USRLAN_161", "Usuário ID --UID-- nome --NAME-- banido");
define("USRLAN_162", "ID de Usuário [x] nome [y] desbanido");
define("USRLAN_163", "Usuário ID --UID-- deletado");
define("USRLAN_164", "Usuário ID --UID-- nome --NAME-- (--EMAIL--) tornado administrador");
define("USRLAN_165", "Usuário ID --UID-- nome --NAME-- teve status de admin revogado");
define("USRLAN_166", "Usuário ID --UID-- nome --NAME-- aprovado");
define("USRLAN_167", "ID de Validação de email [x] reenviado para [y] em [z]");
define("USRLAN_168", "Re-enviados --COUNT-- emails de validação");
