...
define("LAN_NEWS_54", "continuar no modo de edição");
define("LAN_NEWS_55", "Manutenção");
define("LAN_NEWS_56", "Recalcular contagem de comentários");
define("LAN_NEWS_57", "Proceder");
define("LAN_NEWS_58", "Atualização completa - --UPDATE-- comentários atualizados, --DELETED-- comentários não aprovados deletados");
